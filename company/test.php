...
session_start();
	...
	{  
		...
		//echo $date;
		$result=mysqli_query($con, "insert into tbl_order(name,location) VALUES ('$name','$location')");  
	//	$id=mysqli_insert_id('$result');  
	//	$id=return mysqli_insert_id($result)
...
<form action="" method="POST">  
							<div class="box box-primary">  
								...
								<center><h3 class="box-title">XYZ Private Ltd.</h3>
								<br>Janakpur<br>Cash Payment Voucher </center>
								</div>  
								<div class="box-body">  
								<div class="form-group">  
									...
									<div style="width:500px;">  
										...
										<h5 style="float:left;">Pan no : 44444444 </h5>
										<h5>Vat No : 33333333 </h5>
									</div>   
...
..............................<br>
	...
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Checked by
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Approved by 
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspIncloser
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRecived by
<br><br><input type="submit" class="btnbtn-primary" name="save" value="Save Record">  
<input type="submit" class="btnbtn-primary" name="save" onclick ="printFunction()" value="Print and Save Record"> 
...
<script type="text/javascript">  
		...
		{  
			...
			function addVendor(){
				$con = mysqli_connect("localhost", "root", "", "user");
				$sql = "SELECT `id`,`fname`,`lname` FROM `vendor` order by fname";
				echo "<select name=name class='form-control' value=''>Vendor Name</option>"; 
					foreach ($con->query($sql) as $row){
			...
			var tr = '<tr>'+  
			'<td class="no">'+n+'</td>'+ 
			'<td> <select name="name[]"> <option value="1"> Nitesh</option> <option value="1"> Ramesh</option> </select> </td>'+ 
			'<td><input type="text" class="form-control productname" name="productname[]"></td>'+  
			'<td><input type="text" class="form-control amountdr" name="amountdr[]"></td>'+ 
			'<td><input type="text" class="form-control amountcr" name="amountcr[]"></td>'+  
			'<td><a href="#" class="remove">Delete</td>'+  
