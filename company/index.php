...
<!-- Head -->
<head>
<title>Solar Energy an Industrial  | Home </title>
				...
				<div class="container-fluid">
					<nav class="navbar navbar-default">
						<div class="navbar-header navbar-left">
							...
							<h1><a class="navbar-brand" href="index.php"><span>Company</span> Name</a></h1>
						</div>
			...
			<div class="aboutbottom">
				...
				<div class="col-md-6">
					<div class="aboutbottomright">
						<h3>Managing solar energy saving</h3>
						       ...
						       <div id="owl-demo" class="owl-carousel">
					                 <div class="item-owl">
					                	<div class="test-review">
											...
											<div class="textagile">
												<p>Make your moto strong,
												<br>Focus on your aim,
												<br>Do not think too much,
												<br>Just do it</p>
												 <h5>Aashish Mallick</h5>
											</div>
										</div>
					                </div>
					                 <div class="item-owl">
					                	<div class="test-review">
											...
											<div class="textagile">
												<p>Do not wait for the opportunity,
												<br>Just grab it,
												<br>Do you best,
												<br>Then see</p>
												<h5>Aahan Kayastha</h5>
											</div>
					                	</div>
					                </div>
					                 <div class="item-owl">
...
<div class="contact" id="contact">
	...
	<div class="contactright1">
		<p><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Company Name</p>
		<p><span class="glyphicon glyphicon-phone" aria-hidden="true"></span>+977 01-54333</p>
