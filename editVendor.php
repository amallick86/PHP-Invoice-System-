...
<div class="wthree-dot">
		...
		<!-- //Header -->
		<div class="container">
							<h3 class="heading">Edit a vendor of </h3><br>
							<h3><?php echo $row['fname'];?> <?php echo $row['lname'];?></h3><br><br>
...
$sql="SELECT users.uid, users.uname, tbl_orderdetails.id, tbl_orderdetails.order_id, tbl_orderdetails.vendor_id,
...
INNER JOIN users ON tbl_orderdetails.submittedby=users.uid  where tbl_orderdetails.vendor_id='".$p."'";
?><center><h1>Record of<br></h1>
		<h3><?php echo $row['fname'];?> <?php echo $row['lname'];?></h3></center><br><br><?php
